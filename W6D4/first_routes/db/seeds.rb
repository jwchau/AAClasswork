...
share_1 = ArtworkShare.create(artwork_id: rock.id, viewer_id: jack.id)
share_2 = ArtworkShare.create(artwork_id: keyboard.id, viewer_id: jack.id)
share_3 = ArtworkShare.create(artwork_id: ship.id, viewer_id: matt.id)
share_4 = ArtworkShare.create(artwork_id: keyboard.id, viewer_id: hacker.id)
share_5 = ArtworkShare.create(artwork_id: rock.id, viewer_id: albert.id)
